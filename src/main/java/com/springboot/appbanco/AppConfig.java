...
public class AppConfig {
	...
	@Value("${config.base.endpoint.atminfo}")
	private String urlAtmInfo;
	...
	@Bean
	@Qualifier("atmInfo")
	public WebClient registrarWebClientByAtmInfo() {

		return WebClient.create(urlAtmInfo); //EndPoint para conectarse con ese MS.
	}
